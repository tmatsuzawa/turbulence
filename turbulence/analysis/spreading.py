...
def spreading(Mlist, logscale=False):
    ...
    for i, t0 in enumerate(frame[:-1]):
        ...
        graphes.save_figs(figs, savedir='./Spreading/Diffusion_noNoise/', suffix='',
                          prefix='2015_12_28_front_' + str(t0), frmt='png')
...
def display_profile(M, i, t0, z, Ux_moy, Uy_moy, Ux_rms, Uy_rms, Dt=1, fig=1, logscale=True):
    ...
    if logscale:
        ...
        graphes.save_figs(figs, savedir='./Spreading/Stat_average_lin/', suffix='',
                          prefix='2015_12_28_front_' + str(t0), frmt='png')
