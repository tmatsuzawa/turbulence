...
import stephane.mdata
import stephane.mdata.Id as Id
import stephane.mdata.param as param
...
#object  #type of measurement used #future attibutes of a PIV measurement type
    ...
    def load_measures(self,frmt='.hdf5'):
        ...
        """        
        fileList_M = glob.glob(file_architecture.os_c(self.dirCine) + 'M_' + self.Id.date +'/M_'+self.Id.date+'_'+str(self.Id.index)+'_*'+frmt)
    ...
    def load_measure(self,indice=0,frmt='.hdf5'):
        ...
        filename = file_architecture.os_c(self.dirCine) + 'M_' + self.Id.date +'/M_'+self.Id.date+'_'+str(self.Id.index)+'_'+str(indice)+frmt
