"""
Comparison of tracking results between software outputs and tracking algorithm (Hough tracking) outputs
"""
import numpy as np
...
data_tracking_basedir_list = [base_dir + 'pistontuning/no_movement_test']
...
for data_tracking_basedir in data_tracking_basedir_list:
    ...
    for csv_file in csv_files:
        ...
        graph.setaxes(ax2, tmin, tmax, -100, 100)
